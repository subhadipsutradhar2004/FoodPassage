            ...
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
                ...
                <form className='space-y-5' onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input type="text" placeholder='Enter Item Name' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff9900]'
                    ...
                    <div>
                        ...
                        <input type="number" placeholder='0' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff9900]'
                    ...
                    <div>
                        ...
                        <select className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring--[#ff9900]'
