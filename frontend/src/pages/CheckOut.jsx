...
<div className='flex justify-between text-lg font-bold text-[#ff9900] pt-2'>
  ...
  <span>{AmountWithDeliveryFee}</span>
        ...
        <button className='w-full bg-[#ff9900] hover:bg-[#ff9100] text-white py-3 rounded-xl font-semibold cursor-pointer' onClick={handlePlaceOrder}> {paymentMethod=="cod"?"Place Order":"Pay & Place Order"}</button>
